...
No reporting code, migration, external notification, credential configuration or live submission is introduced by this requirements package. APP-08 and APP-09 remain open for implementation and acceptance; MFA remains paused.
