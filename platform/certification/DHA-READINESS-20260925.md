...
| Security and recovery | Role/tenant boundaries, restore target/checksum/system-identity safeguards, backup/audit tooling | Independent penetration test and remediation, encrypted independent backup custody, witnessed restore with measured RPO/RTO, downtime/incident rehearsal |
