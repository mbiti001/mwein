...
const operationalRoles = {
  ...
  FACILITY_ADMIN: { name: "Facility administrator", grants: ["reports.clinical", "reports.operations", "patient.read", "visit.read", "visit.cancel", "billing.read", "accounting.view", "admin.dashboard", "admin.users", "admin.assign_governance", "admin.catalog", "admin.operations", "audit.view", "inventory.view"] },
  MEDICAL_DIRECTOR: { name: "Medical director", grants: ["reports.clinical", "patient.read", "visit.read", "encounter.write", "clinical.history.read", "clinical.results.read", "clinical.summary.read", "referral.read", "order.write", "admin.dashboard", "admin.clinical_safety", "audit.view"] },
