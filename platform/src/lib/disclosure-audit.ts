...
export type DisclosureContext = `OPERATIONS_READ:${string}` | "AUDIT_EXPORT" | "STAFF_ACCESS" | "FOLLOW_UPS" | "QUEUES" | "SERVICE_POINTS" | "MEASURED_VITALS" | "SURVEILLANCE" | "CLINIC_DOCUMENT" | "LOCAL_REPORT" | "APPOINTMENTS" | "DISPENSING_DETAILS" | "PATIENT_PROBLEMS" | "REFERRALS" | "MONTHLY_REPORT" | "OPERATIONS_REPORT";
