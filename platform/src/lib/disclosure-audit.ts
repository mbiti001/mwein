...
export type DisclosureContext = "MEASURED_VITALS" | "SURVEILLANCE" | "LOCAL_REPORT" | "APPOINTMENTS" | "DISPENSING_DETAILS" | "PATIENT_PROBLEMS" | "REFERRALS" | "MONTHLY_REPORT" | "OPERATIONS_REPORT";
